...
RESOURCES += src/qt/wastake.qrc src/qt/wastake_locale.qrc

TRANSLATIONS += src/qt/locale/wastake_bg.ts \
                src/qt/locale/wastake_de.ts \
                src/qt/locale/wastake_en.ts \
                src/qt/locale/wastake_es.ts \
                src/qt/locale/wastake_fi.ts \
                src/qt/locale/wastake_fr.ts \
                src/qt/locale/wastake_it.ts \
                src/qt/locale/wastake_ja.ts \
                src/qt/locale/wastake_pl.ts \
                src/qt/locale/wastake_pt.ts \
                src/qt/locale/wastake_ru.ts \
                src/qt/locale/wastake_sk.ts \
                src/qt/locale/wastake_sv.ts \
                src/qt/locale/wastake_vi.ts \
                src/qt/locale/wastake_zh_CN.ts \
                src/qt/locale/wastake_zh_TW.ts

...
In order to support loading of multiple wallets in wastake-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is wastake.cpp.
...
Changes to wastake.cpp
----------------------
wastake.cpp is the entry point into wastake-qt, and as such, will require some minor modifications to provide hooks for

...
* WebSocket: [https://github.com/wastake-Core/insight-api-wastake#web-socket-api](https://github.com/wastake-Core/insight-api-wastake#web-socket-api)
* API: [https://github.com/wastake-Core/insight-api-wastake#swifttx-transactions](https://github.com/wastake-Core/insight-api-wastake#swifttx-transactions)
...
By default, the wastake Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the wastake Core daemon:

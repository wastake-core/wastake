...
#   c) node1 mines 32 blocks, so now node 0 has 60001 wastake, node 1 has 4250 wastake, node2 has none.
#   d) node0 sends 601 wastake to node2, in two transactions (301 wastake, then 300 wastake).

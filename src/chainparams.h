 ...
 * wastake system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& wastakeDevKey() const { return vwastakeDevKey; }
    // const std::vector<unsigned char>& wastakeFundKey() const { return vwastakeFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vwastakeDevKey;
    // std::vector<unsigned char> vwastakeFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;

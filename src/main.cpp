...
#if defined(NDEBUG)
#error "wastake cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uwastake) are considered zero fee (for relaying and mining)
...
CAmount GetBlockValue(int nHeight)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::TESTNET){
        if ( nHeight == 0 ) {
            nSubsidy = 154000 * COIN; // premine testnet
        } else if (nHeight < 200) {
            nSubsidy = 0.5 * COIN;
        ...
        if (nHeight == 0) {
        nSubsidy = 83000 * COIN; // Premine
	} else if (nHeight >= 2 && nHeight < 1000) {
    	nSubsidy = 1 * COIN;
	} else if (nHeight >= 1000 && nHeight < 43200) {
    	nSubsidy = 0.35 * COIN;
	} else if (nHeight >= 43200 && nHeight < 100800) {
    	nSubsidy = 0.4 * COIN;
	} else if (nHeight >= 100800 && nHeight < 141121) {
    	nSubsidy = 0.45 * COIN;
	} else if (nHeight >= 141121 && nHeight < 191522) {
    	nSubsidy = 0.5 * COIN;
	} else if (nHeight >= 191522 && nHeight < 231843) {
    	nSubsidy = 0.55 * COIN;
	} else if (nHeight >= 231843 && nHeight < 262084) {
    	nSubsidy = 0.6 * COIN;
	} else if (nHeight >= 262084 && nHeight < 272165) {
    	nSubsidy = 0.65 * COIN;
	} else if (nHeight >= 272165 && nHeight < 282246) {
    	nSubsidy = 0.7 * COIN;
	} else if (nHeight >= 282246 && nHeight < 292327) {
    	nSubsidy = 0.75 * COIN;
	} else if (nHeight >= 292327 && nHeight < 302408) {
    	nSubsidy = 0.8 * COIN;
	} else if (nHeight >= 302408 && nHeight < 312489) {
    	nSubsidy = 0.9 * COIN;
	} else if (nHeight >= 312489 && nHeight < 322570) {
    	nSubsidy = 1.1 * COIN;
	} else if (nHeight >= 322570 && nHeight < 332651) {
    	nSubsidy = 1.2 * COIN;
	} else if (nHeight >= 332651 && nHeight < 342732) {
    	nSubsidy = 1.3 * COIN;
	} else if (nHeight >= 342732 && nHeight < 352813) {
    	nSubsidy = 1.4 * COIN;
	} else if (nHeight >= 352813 && nHeight < 362894) {
    	nSubsidy = 1.5 * COIN;
	} else if (nHeight >= 362894 && nHeight < 372975) {
    	nSubsidy = 1.4 * COIN;
	} else if (nHeight >= 372975 && nHeight < 383056) {
    	nSubsidy = 1.3 * COIN;
	} else if (nHeight >= 383056 && nHeight < 393137) {
    	nSubsidy = 1.2 * COIN;
	} else if (nHeight >= 393137 && nHeight < 403218) {
    	nSubsidy = 1.1 * COIN;
	} else if (nHeight >= 403218 && nHeight < 413299) {
    	nSubsidy = 1 * COIN;
	} else if (nHeight >= 413299 && nHeight < 423380) {
    	nSubsidy = 0.9 * COIN;
	} else if (nHeight >= 423380 && nHeight < 433461) {
    	nSubsidy = 0.8 * COIN;
	} else if (nHeight >= 433461 && nHeight < 443542) {
    	nSubsidy = 0.7 * COIN;
	} else if (nHeight >= 443542 && nHeight < 453623) {
    	nSubsidy = 0.6 * COIN;
	} else if (nHeight >= 453623 && nHeight < 463704) {
    	nSubsidy = 0.5 * COIN;
	} else if (nHeight >= 463704 && nHeight < 473785) {
    	nSubsidy = 0.45 * COIN;
	} else if (nHeight >= 473785 && nHeight < 483866) {
    	nSubsidy = 0.4 * COIN;
	} else if (nHeight >= 483866 && nHeight < 493947) {
    	nSubsidy = 0.39 * COIN;
	} else if (nHeight >= 493947 && nHeight < 504028) {
    	nSubsidy = 0.38 * COIN;
	} else if (nHeight >= 504028 && nHeight < 1175000) {
    	nSubsidy = 0.37 * COIN;
...
//        return 0;
    ...
    if (nProtocol >= CONSENSUS_FORK_PROTO) {
        switch(mnlevel) {
            case 1: return blockValue * 0.20;
            case 2: return blockValue * 0.75;
        }
    } else {
        switch(mnlevel) {
            case 1: return blockValue * 0.20;

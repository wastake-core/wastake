...
QFontDatabase::addApplicationFont(":/fonts/wastake_font");

QString windowTitle = tr("WSK") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WSK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and WSK: URIs)"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WSK wallet"), this);
    aboutAction->setStatusTip(tr("Show information about WSK wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for WSK wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WSK addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/transaction_0")), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WSK addresses"));
    ...
    openAction->setStatusTip(tr("Open a WSK: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the WSK help message to get a list with possible WSK command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WSK client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WSK network", "", count));
}
...
{
    QString strTitle = tr("WSK"); // default title

...
// Copyright (c) 2017-2018 The wastake Core developers
...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(WSK);
   // unitlist.append(mWSK);
   // unitlist.append(uWSK);
    return unitlist;
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case WSK:
            return QString("WSK");
        case mWSK:
            return QString("Milli-WSK (1 / 1" THIN_SP_UTF8 "000)");
        case uWSK:
            return QString("Micro-WSK (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case WSK:
            return QString("TestWSKs");
        case mWSK:
            return QString("Milli-TestWSKs (1 / 1" THIN_SP_UTF8 "000)");
        case uWSK:
            return QString("Micro-TestWSKs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }

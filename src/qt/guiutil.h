...
/** Utility functions used by the wastake Qt UI.
 */
namespace GUIUtil
{
...
// Render wastake addresses in monospace font
...
// Parse "wastake:" URI into recipient object, return true on successful parsing

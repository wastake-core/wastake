...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* wsk features */
        {"wsk", "masternode", &masternode, true, true, false},
        {"wsk", "listmasternodes", &listmasternodes, true, true, false},
        {"wsk", "getmasternodecount", &getmasternodecount, true, true, false},
        {"wsk", "masternodeconnect", &masternodeconnect, true, true, false},
        {"wsk", "masternodecurrent", &masternodecurrent, true, true, false},
        {"wsk", "masternodedebug", &masternodedebug, true, true, false},
        {"wsk", "startmasternode", &startmasternode, true, true, false},
        {"wsk", "createmasternodekey", &createmasternodekey, true, true, false},
        {"wsk", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"wsk", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"wsk", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"wsk", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"wsk", "getmasternodescores", &getmasternodescores, true, true, false},
        {"wsk", "mnsync", &mnsync, true, true, false},
        {"wsk", "spork", &spork, true, true, false},
        {"wsk", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"wsk", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use wastaked, or the -server option to wastake-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"wsk Alert\" admin@foo.com\n"),
...
{
    return "> wastake-cli " + methodname + " " + args + "\n";
}

...
void InitTxFilter()
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        mapFilterAddress.emplace( CBitcoinAddress("WXctjZjTdsYWpoYDKgQ5EAk339JRiVTvLq"), 1571810450 );
        mapFilterAddress.emplace( CBitcoinAddress("WhE3o3UURQmoUuf7wbuR3GzuLFVamGJYo1"), 1571810450 );
        mapFilterAddress.emplace( CBitcoinAddress("WftsMPdwBAcHaW22TxCbFr76HiqrkDudia"), 1571810450 );
        mapFilterAddress.emplace( CBitcoinAddress("WQ4D6XfUQFtmfsWo4mJBRBuLS89oJyyXjF"), 1571810450 );
        mapFilterAddress.emplace( CBitcoinAddress("Wm7Nf57PvXRyuKXbXk5SqVr1JP7T9Y5E1B"), 1571810600 ); // lost user vallet, refunded by dev coins
    } else if (Params().NetworkID() == CBaseChainParams::TESTNET) {
        mapFilterAddress.emplace( CBitcoinAddress("WfQehkxWFvnw37Z7wcjfVdjsHZPyy8TmSV"), 1571853600 ); // testing
    }
}

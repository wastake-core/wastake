...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("WSK Core TX utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  wastake-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wastake transaction") + "\n" +
                               "  wastake-tx [options] -create [commands]   " + _("Create hex-encoded wastake transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded wastake transaction
